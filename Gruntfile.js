// Generated on 2014-10-24 using generator-socketio 0.0.3
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    cssmin: {
      combine: {
        files: {
          'public/css/core.css': 'public/bower_components/bootstrap/css/bootstrap.css'
        }
      }
    },
    ...
    nodemon:{
      dev: {
        options: {
          ...
          watchedFolders: ['views', 'routes', 'server.js'],
          env: {
            PORT: RUNNING_PORT
          },
          cwd: __dirname
